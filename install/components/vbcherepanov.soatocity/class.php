...
class VbcherepanovSoatoCity extends \CBitrixComponent implements Contract\Controllerable
{
    /**
    ...
    public function getListenerCityAction($val)
    {
        ...
        $data['DATA'] = 1;
        $data['ERROR'] = '';
        $data['CITY'] = \Vbcherepanov\Soato\soatocity::loadCity($query,20);
